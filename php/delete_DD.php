...
<a href="delete_D.php" style="color:blue"> ▶ 환자정보삭제 </a>
<a href="물품관리_대구.php" > ▶ 물품관리 </a>
</div>
<div id ="m">
<?php
   $con=mysqli_connect("localhost", "root", "1234", "govdb") or die("MySQL 접속 실패 !!");
   $sql ="SELECT * FROM patient_table WHERE patient_table.pid = '".$_GET['pid']."' AND patient_table.hospital_name='대구병원'";
...
<body>
<FORM METHOD="post" ACTION="delete_result_D.php">
      환자 번호 : <INPUT TYPE = "text" NAME="patient_num" VALUE=<?php echo $patient_num ?> READONLY> <br>
      환자 이름 : <INPUT TYPE = "text" NAME="patient_name" VALUE=<?php echo $patient_name ?> READONLY> <br>
      주민 번호 : <INPUT TYPE = "text" NAME="pid" VALUE=<?php echo $pid ?> READONLY>  <br>
      검사일    : <INPUT TYPE = "text" NAME="check_date" VALUE=<?php echo $check_date ?> READONLY> <br>
      코로나 확진여부 : <INPUT TYPE = "text" NAME="COVID19_test_result" VALUE=<?php echo $COVID19_test_result ?> READONLY> <br>
      확진일    : <INPUT TYPE = "text" NAME="COVID19_diagnosis" VALUE=<?php echo $COVID19_diagnosis ?> READONLY> <br>
      입원일    : <INPUT TYPE = "text" NAME="hospitalization_date" VALUE=<?php echo $hospitalization_date ?> READONLY> <br>
      퇴원일    : <INPUT TYPE = "text" NAME="discharge_date" VALUE=<?php echo $discharge_date ?> READONLY> <br>
      사망일    : <INPUT TYPE = "text" NAME="death_date" VALUE=<?php echo $death_date ?> READONLY> <br>
      접종 여부 : <INPUT TYPE = "text" NAME="inoculation" VALUE=<?php echo $inoculation ?> READONLY> <br>
      접종 날짜 : <INPUT TYPE = "text" NAME="vaccination_date" VALUE=<?php echo $vaccination_date ?> READONLY> <br>
      접종한 백신 고유번호 : <INPUT TYPE = "text" NAME="vaccine_num" VALUE=<?php echo $vaccine_num ?> READONLY> <br>
      돌파감염여부 : <INPUT TYPE = "text" NAME="breakthrough_infection" VALUE=<?php echo $breakthrough_infection ?> READONLY> <br>
      <BR><BR>
      위 환자 정보를 삭제 하시겠습니까?
