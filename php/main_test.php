...
<div class="inner_login">
    <div class="login_tistory">
        <form method="post" id = "authForm" action ='test_filter.php'>
                <div class="inp_text">
                ...
                <input type="text" id="loginPw" name="userName" placeholder="Password">
                </div>
                <input type='submit' value='로그인' class="btn_login"  onclick="location.href='test_filter.php'"/>
