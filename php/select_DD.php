...
<div id = "main">
<div id = "form">
<a href="select_D.php" style="color:blue"> ▶ 환자정보조회 </a>
...
<?php
   ...
   FROM patient_table WHERE pid='".$_GET['pid']."' AND patient_table.hospital_name='대구병원'";
   ...
   echo "<TD>", "<a href='update_DD.php?pid=",$_GET['pid'],  "'>수정</a></TD>";
  
   echo "<TD>", "<a href='delete_DD.php?pid=",$_GET['pid'],  "'>삭제</a></TD>";
   echo "</TR>";
   }   
   mysqli_close($con);
   echo "</TABLE>"; 
