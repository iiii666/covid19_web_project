...
<?php
  ...
  $sql = "UPDATE patient_table SET patient_name='".$patient_name."',pid='".$pid."',hospital_name='"."영남대병원"."',
  ...
  breakthrough_infection='".$breakthrough_infection."' WHERE pid = '".$_POST['pid']."' AND patient_table.hospital_name='영남대병원'";

  
  $ret = mysqli_query($con,$sql);
  echo "<h1> 환자 정보 수정 결과</h1>"."<br><br><br>";
  if($ret)
  {
