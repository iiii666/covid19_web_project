...
<?php
  ...
  $sql = "UPDATE patient_table SET patient_name='".$patient_name."',pid='".$pid."',hospital_name='"."경북대병원"."',
  ...
  breakthrough_infection='".$breakthrough_infection."' WHERE pid = '".$_POST['pid']."' AND patient_table.hospital_name='경북대병원'";
